...
/*!
    ...
    \fn       void cGELPlaydohMesh::initialise()
*/
//===========================================================================
void cGELPlaydohMesh::initialise()
{
...
/*!
    ...
    \fn       void cGELPlaydohMesh::clearForces()
*/
//===========================================================================
void cGELPlaydohMesh::clearForces()
{
    if (m_useSkeletonModel)
    {
        list<cGELPlaydohSkeletonNode*>::iterator i;
    ...
    {
        vector<cGELPlaydohVertex>::iterator i;
...
/*!
    ...
    \fn       void cGELPlaydohMesh::clearExternalForces()
*/
//===========================================================================
void cGELPlaydohMesh::clearExternalForces()
{
    if (m_useSkeletonModel)
    {
        list<cGELPlaydohSkeletonNode*>::iterator i;
...
/*!
    ...
    \fn       void cGELPlaydohMesh::computeForces()
*/
//===========================================================================
void cGELPlaydohMesh::computeForces()
{
    if (m_useSkeletonModel)
    {
        list<cGELPlaydohSkeletonLink*>::iterator i;
    ...
    if (m_useMassParticleModel)
    {
        list<cGELPlaydohLinearSpring*>::iterator i;
...
/*!
    ...
    \fn       void cGELPlaydohMesh::computeNextPose(double a_timeInterval)
*/
//===========================================================================
void cGELPlaydohMesh::computeNextPose(double a_timeInterval)
{
    if (m_useSkeletonModel)
    {
        list<cGELPlaydohSkeletonNode*>::iterator i;
...
/*!
    ...
    \fn       void cGELPlaydohMesh::applyNextPose()
*/
//===========================================================================
void cGELPlaydohMesh::applyNextPose()
{
    if (m_useSkeletonModel)
    {
        list<cGELPlaydohSkeletonNode*>::iterator i;
...
void cGELPlaydohMesh::updateAllDynamics(double a_timeInterval)
{
	// check skeleton mode and expected sizes of links and nodes
	if (m_useSkeletonModel && m_links.size() == m_nodes.size())
	{
		list<cGELPlaydohSkeletonNode*>::iterator i;
		list<cGELPlaydohSkeletonNode*>::iterator nextIter;
...
*/
//===========================================================================
void cGELPlaydohMesh::render(cRenderOptions& a_options)
{
	// render mesh
	...
	if (SECTION_RENDER_OPAQUE_PARTS_ONLY(a_options))
	{
		...
		if (m_showSkeletonModel)
		{
			...
			else
			{
				if (!m_renderNodes.empty())
				{
					...
					{
						cGELPlaydohSkeletonNode* nextItem = *i;
						nextItem->render();
					}
				}
				...
				//{
				//	list<cGELPlaydohSkeletonLink*>::iterator j;
				//	for (j = m_renderLinks.begin(); j != m_renderLinks.end(); ++j)
				//	{
				//		cGELPlaydohSkeletonLink* nextItem = *j;
				//		nextItem->render();
				//	}
				//}
		...
		if (m_showMassParticleModel)
		{
			...
			list<cGELPlaydohLinearSpring*>::iterator j;
...
void cGELPlaydohMesh::setMutex(std::mutex* a_mutex)
{
	// set mutex
	m_mutex = a_mutex;
...
/*!
    ...
    \fn       void cGELPlaydohMesh::buildVertices();
*/
//===========================================================================
void cGELPlaydohMesh::buildVertices()
{
	...
	for (int i = 0; i<numVertices; i++)
	{
		...
		{
			cGELPlaydohVertex newDefVertex(mesh, vertexIndex);
...
/*!
    ...
    \fn     void cGELPlaydohMesh::connectVerticesToSkeleton(bool a_connectToNodesOnly)
    \param  a_connectToNodesOnly  if \b true, then skin is only connected to nodes.
                otherwise skin shall be connected to links too.
*/
//===========================================================================
void cGELPlaydohMesh::connectVerticesToSkeleton(bool a_connectToNodesOnly)
{
    // get number of vertices
    ...
    for (int i=0; i<numVertices; i++)
    {
        ...
        cGELPlaydohVertex* curVertex = &m_gelVertices[i];
        ...
        cGELPlaydohSkeletonNode* nearest_node = NULL;
        cGELPlaydohSkeletonLink* nearest_link = NULL;

        // search for the nearest node
		list<cGELPlaydohSkeletonNode*>::iterator itr;
        for(itr = m_nodes.begin(); itr != m_nodes.end(); ++itr)
        {
            cGELPlaydohSkeletonNode* nextNode = *itr;
        ...
        if (!a_connectToNodesOnly)
        {
            ...
            {
                cGELPlaydohSkeletonLink* nextLink = *j;
...
/*!
    ...
    \fn       void cGELPlaydohMesh::updateVertexPosition()
*/
//===========================================================================
void cGELPlaydohMesh::updateVertexPosition()
{
    if (m_useSkeletonModel)
    {
        // get number of vertices
