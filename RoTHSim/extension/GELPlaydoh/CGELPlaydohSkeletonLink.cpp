...
// Physical properties:
double cGELPlaydohSkeletonLink::s_default_kSpringElongation = 100.0; // [N/m]
double cGELPlaydohSkeletonLink::s_default_kSpringFlexion    = 0.1;   // [Nm/RAD]
double cGELPlaydohSkeletonLink::s_default_kSpringTorsion   = 0.1;    // [Nm/RAD]

// Graphical properties:
cColorf cGELPlaydohSkeletonLink::s_default_color(0.2f, 0.2f, 1.0f);


//===========================================================================
/*!
    Constructor of cGELPlaydohSkeletonLink.

    \fn     cGELPlaydohSkeletonLink::cGELPlaydohSkeletonLink(cGELPlaydohSkeletonNode* a_node0,
                                               cGELPlaydohSkeletonNode* a_node1)
    \param  a_node0  Node 0.
    \param  a_node1  Node 1.
*/
//===========================================================================
cGELPlaydohSkeletonLink::cGELPlaydohSkeletonLink(cGELPlaydohSkeletonNode* a_node0, cGELPlaydohSkeletonNode* a_node1)
{
    // Set nodes:
    m_node0 = a_node0;
    m_node1 = a_node1;
...
//===========================================================================
/*!
     Destructor of cGELPlaydohSkeletonLink.

      \fn       cGELPlaydohSkeletonLink::~cGELPlaydohSkeletonLink()
*/
//===========================================================================
cGELPlaydohSkeletonLink::~cGELPlaydohSkeletonLink()
{
