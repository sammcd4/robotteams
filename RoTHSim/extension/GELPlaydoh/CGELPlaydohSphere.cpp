...
//===========================================================================
/*!
    Constructor of cGELPlaydohSphere.

    \fn     cGELPlaydohSphere::cGELPlaydohSphere(const double& a_radius)
    \param  a_radius    Radius of sphere
*/
//===========================================================================
cGELPlaydohSphere::cGELPlaydohSphere(const double& a_radius)
{
	// is at robot location
	m_atRobot = false;
...
/*!
    ...
    \fn       void cGELPlaydohSphere::render(const int a_renderMode)
    \param    a_renderMode  See cGenericObject::render()
*/
//===========================================================================
void cGELPlaydohSphere::render(const int a_renderMode)
{
    //-----------------------------------------------------------------------
...
/*!
    ...
    \fn     void cGELPlaydohSphere::computeLocalInteraction(const cVector3d& a_toolPos,
...
*/
//===========================================================================
void cGELPlaydohSphere::computeLocalInteraction(const cVector3d& a_toolPos,
                                          const cVector3d& a_toolVel,
                                          const unsigned int a_IDN)
{
...
/*!
    ...
    \fn       void cGELPlaydohSphere::updateBoundaryBox()
*/
//===========================================================================
void cGELPlaydohSphere::updateBoundaryBox()
{
...
/*!
    ...
    \fn       void cGELPlaydohSphere::scaleObject(const cVector3d& a_scaleFactors)
    \param    a_scaleFactors Scale factor
*/
//===========================================================================
void cGELPlaydohSphere::scaleObject(const cVector3d& a_scaleFactors)
{
