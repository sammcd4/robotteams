...
//---------------------------------------------------------------------------
#ifndef CGELPlaydohMassParticleH
#define CGELPlaydohMassParticleH
//---------------------------------------------------------------------------
#include "chai3d.h"
//---------------------------------------------------------------------------
...
//===========================================================================
/*!
    \file       cGELPlaydohMassParticle.h
...
//===========================================================================
/*!
    \class      cGELPlaydohMassParticle
    \ingroup    GEL

    \brief      
    cGELPlaydohMassParticle defines a simple mass particle point.
*/
//===========================================================================
class cGELPlaydohMassParticle
{
  public:
    ...
    cGELPlaydohMassParticle();

    //! Destructor of cGELPlaydohMassParticle.
    virtual ~cGELPlaydohMassParticle();
    ...
    inline void render()
    {
        ...
        cVector3d v = cAdd(m_pos, cMul(s_scale_force_vector_display, m_externalForce));
        glBegin(GL_LINES);
          glVertex3dv( (const double *)&m_pos);
