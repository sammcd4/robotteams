...
//---------------------------------------------------------------------------
#ifndef CGELPlaydohSkeletonLinkH
#define CGELPlaydohSkeletonLinkH
//---------------------------------------------------------------------------
#include "chai3d.h"
...
//===========================================================================
/*!
    \file       cGELPlaydohSkeletonLink.h
...
//===========================================================================
/*!
    \class      cGELPlaydohSkeletonLink
    \ingroup    GEL

    \brief      
    cGELPlaydohSkeletonLink models a link between two nodes.
*/
//===========================================================================
class cGELPlaydohSkeletonLink
{
  public:
    ...
    cGELPlaydohSkeletonLink(cGELPlaydohSkeletonNode* a_node0, cGELPlaydohSkeletonNode* a_node1);

    //! Destructor of cGELPlaydohSkeletonLink.
    ~cGELPlaydohSkeletonLink();
    ...
    /*!
         ...
         \fn       void cGELPlaydohSkeletonLink::render()
    */
    //-----------------------------------------------------------------------
    inline void render()
    {
    ...
    /*!
         ...
         \fn       void cGELPlaydohSkeletonLink::computeForces()
    */
    //-----------------------------------------------------------------------
    ...
    cGELPlaydohSkeletonNode *m_node0;

    //! Node 1 of current link.
    cGELPlaydohSkeletonNode *m_node1;
