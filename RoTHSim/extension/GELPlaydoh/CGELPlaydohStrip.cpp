...
/*!
    ...
    \fn     cGELPlaydohStrip::cGELPlaydohStrip()
    \param  a_
*/
//===========================================================================
cGELPlaydohStrip::cGELPlaydohStrip(cWorld* a_world, cGELPlaydohMesh* a_playdohMesh, bool a_isCurved, bool a_isPrevStrip, bool a_isFutureStrip, cVector3d a_p0, cVector3d a_p1, cVector3d a_p2, cVector3d a_p3)
{
	...
	// create GELPlaydoh strip connecting robots 1 and 2
	if(m_isCurved)
		createCurvedStrip();
	else createLineStrip();
};

void cGELPlaydohStrip::setStiffness(double a_stiffness)
{
...
void cGELPlaydohStrip::createLineStrip()
{
...
void cGELPlaydohStrip::createLinks()
{
...
void cGELPlaydohStrip::setIsCurved(bool a_isCurved)
{
	m_isCurved = a_isCurved;
}

void cGELPlaydohStrip::createCurvedStrip()
{
...
void cGELPlaydohStrip::updateGELPlaydohStrip(cVector3d a_p0, cVector3d a_p1, cVector3d a_p2, cVector3d a_p3)
{
	...
	//for (int i = 0; i < numSpheres; i++)
	cGELPlaydohSkeletonNode* sphere;
	list<cGELPlaydohSkeletonNode*>::iterator iter;
	int i = 0;
	for (iter = m_spheres.begin(); iter != m_spheres.end(); iter++)
	{
 ...
 void cGELPlaydohStrip::addSphere(cGELPlaydohSkeletonNode* a_sphere1, cGELPlaydohSkeletonNode* a_sphere2, list<cGELPlaydohSkeletonNode*>::iterator iter)
{
 ...
 list<cGELPlaydohSkeletonNode*>::iterator cGELPlaydohStrip::removeSphere(list<cGELPlaydohSkeletonNode*>::iterator iter)
{
 ...
 cVector3d cGELPlaydohStrip::computeForce(const cVector3d& a_cursor, double a_cursorRadius)
 {
	 // init temp variable
	 cVector3d force;
	 force.zero();
 ...
 cVector3d cGELPlaydohStrip::computeNodeForce(const cVector3d& a_cursor,
