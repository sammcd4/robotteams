...
public:
	// Constructor
	cTargetManager(cGenericObject* a_parent);
	...
	// set target groups
	void setTargetGroups(vector<cTargetGroup*> a_targetGroups);
	...
	vector<cTargetGroup*> getActiveTargetGroups();
...
private:
	...
	vector<cTargetGroup*> m_targetGroups;
