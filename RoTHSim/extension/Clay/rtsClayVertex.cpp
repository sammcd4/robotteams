...
*/
//==========================================================================
rtsClayVertex::rtsClayVertex(chai3d::cMesh* a_mesh, unsigned int a_vertexIndex)
{
	m_mesh = a_mesh;
	m_vertexIndex = a_vertexIndex;
	m_massParticle = new rtsClayMassParticle();
	m_link = NULL;
	m_node = NULL;
...
/*!
    ...
    \fn       rtsClayVertex::~rtsClayVertex()
*/
//==========================================================================
rtsClayVertex::~rtsClayVertex()
{
