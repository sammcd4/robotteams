...
/*!
    ...
    \brief      
    rtsClayLink models a link between two nodes.
*/
//===========================================================================
class rtsClayLink
{
  public:
    ...
    rtsClayLink(rtsClayNode* a_node0, rtsClayNode* a_node1);
    ...
    */
    ...
    /*!
         ...
         \fn       void rtsClayLink::computeForces()
    */
    //-----------------------------------------------------------------------
