...
// Physical properties:
double rtsClayNode::s_default_radius				 = 0.05;
double rtsClayNode::s_default_kDampingPos			 = 5.00;
double rtsClayNode::s_default_muStaticFrictionPos	 = 10.0;
double rtsClayNode::s_default_muStaticFrictionRot	 = 0.5;
double rtsClayNode::s_default_muDynamicFrictionPos = 0.2;
double rtsClayNode::s_default_muDynamicFrictionRot = 0.2;
double rtsClayNode::s_default_kDampingRot			 = 0.1;
double rtsClayNode::s_default_mass				 = 0.1;  // [kg]
double rtsClayNode::s_default_stiffness			 = 10.0;

// Graphic properties:
bool rtsClayNode::s_default_showFrame       = true;
cColorf rtsClayNode::s_default_color(1.0f, 0.4f, 0.4f);
double rtsClayNode::s_default_frameScale = 1.0;

// Gravity field:
bool rtsClayNode::s_default_useGravity      = true;
cVector3d rtsClayNode::s_default_gravity(0.00, 0.00, -9.81);
...
/*!
    ...
    \fn       rtsClayNode::rtsClayNode()
*/
//===========================================================================
rtsClayNode::rtsClayNode()
{
    m_pos.zero();
    m_rot.identity();
...
/*!
    ...
    \fn       void rtsClayNode::render()
*/
//===========================================================================
void rtsClayNode::setMass(double a_mass)
{
    m_mass = a_mass;
