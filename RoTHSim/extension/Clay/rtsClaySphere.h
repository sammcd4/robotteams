...
//---------------------------------------------------------------------------
#ifndef rtsClaySphere2H
#define rtsClaySphere2H
//---------------------------------------------------------------------------
# include "chai3d.h"
...
*/
//===========================================================================
class rtsClaySphere : public cGenericObject
{
  public:
    ...
    rtsClaySphere(const double& a_radius);
    
    //! Destructor of cSphere.
    virtual ~rtsClaySphere() {};
