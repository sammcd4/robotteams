...
//---------------------------------------------------------------------------
#ifndef rtsClayLinearSpringH
#define rtsClayLinearSpringH
//---------------------------------------------------------------------------
#include "chai3d.h"
...
//===========================================================================
/*!
    \class      rtsClayLinearSpring
    \ingroup    GEL

    \brief      
    rtsClayLinearSpring models a linear spring between two mass particles.
*/
//===========================================================================
class rtsClayLinearSpring
{
  public:
    ...
    rtsClayLinearSpring(rtsClayMassParticle* a_node0, rtsClayMassParticle* a_node1);
    ...
    */
    ...
    rtsClayMassParticle *m_node0;

    //! Node 1 of current link.
    rtsClayMassParticle *m_node1;
