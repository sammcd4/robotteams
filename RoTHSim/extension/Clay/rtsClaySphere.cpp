...
//===========================================================================
/*!
    Constructor of rtsClaySphere.

    \fn     rtsClaySphere::rtsClaySphere(const double& a_radius)
    \param  a_radius    Radius of sphere
*/
//===========================================================================
rtsClaySphere::rtsClaySphere(const double& a_radius)
{
...
/*!
    ...
    \fn       void rtsClaySphere::render(const int a_renderMode)
    \param    a_renderMode  See cGenericObject::render()
*/
//===========================================================================
void rtsClaySphere::render(const int a_renderMode)
{
    ////-----------------------------------------------------------------------
...
/*!
    ...
    \fn     void rtsClaySphere::computeLocalInteraction(const cVector3d& a_toolPos,
...
*/
//===========================================================================
void rtsClaySphere::computeLocalInteraction(const cVector3d& a_toolPos,
                                          const cVector3d& a_toolVel,
                                          const unsigned int a_IDN)
{
...
/*!
    ...
    \fn       void rtsClaySphere::updateBoundaryBox()
*/
//===========================================================================
void rtsClaySphere::updateBoundaryBox()
{
...
/*!
    ...
    \fn       void rtsClaySphere::scaleObject(const cVector3d& a_scaleFactors)
    \param    a_scaleFactors Scale factor
*/
//===========================================================================
void rtsClaySphere::scaleObject(const cVector3d& a_scaleFactors)
{
