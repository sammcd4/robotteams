...
//---------------------------------------------------------------------------
#ifndef RTSDEMOINSTRUCTIONH
#define RTSDEMOINSTRUCTIONH
//---------------------------------------------------------------------------
#include "chai3d.h"
//---------------------------------------------------------------------------
...
*/
//===========================================================================
class rtsDemoInstruction: public cGenericObject
{
  public:
	...
	//! Constructor of rtsDemoInstruction.
	  ...
	  //rtsDemoInstruction(double a_startTime, cVector3d a_localPos = cVector3d(0, 0, 0), string a_responseType = "", double a_fadeDuration = 1.0);
	  
	  rtsDemoInstruction(double a_startTime, double a_minDuration, double a_maxDuration, 
							cVector3d a_localPos = cVector3d(0, 0, 0), string a_responseType = "", double a_fadeDuration = 1.0);
	  
	  rtsDemoInstruction(double a_startTime, double a_minDuration, double a_maxDuration, string a_messageText, int a_windowW, int a_windowH, 
							string a_responseType = "", int a_negVertOffset = 100, double a_fadeDuration = 1.0);

	  rtsDemoInstruction(double a_startTime, double a_minDuration, double a_maxDuration, vector<string> a_messages, int a_windowW, int a_windowH, 
		  					string a_responseType = "", int a_negVertOffset = 100, double a_fadeDuration = 1.0);
    
	//! Destructor of rtsDemoInstruction.
	  virtual ~rtsDemoInstruction();
...
protected:
	...
	void initDemoInstruction(double a_startTime, double a_minDuration, double a_maxDuration,
