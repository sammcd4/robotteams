...
struct rtsVector3d
{
    ...
    //-----------------------------------------------------------------------
    /*!
      Constructors of rtsVector3d.

      You can initialize a rtsVector3d from any of the following: \n
    ...
    */
    ...
    rtsVector3d(const char* a_initstr) { set(a_initstr); }

    //! Constructor by passing a string to initialize vector.
    rtsVector3d(const string& a_initstr) { set(a_initstr); }

    //! Constructor by passing a doubles to initialize vector.
    rtsVector3d(const double a_x, const double a_y,
        const double a_z) : x(a_x), y(a_y), z(a_z) { }

    //! Constructor by passing a vector to initialize vector.
    rtsVector3d(const rtsVector3d& a_source) : x(a_source.x), y(a_source.y), z(a_source.z) { }

    //! Constructor by passing an array of doubles to initialize vector.
    rtsVector3d(const double* a_in) : x(a_in[0]), y(a_in[1]), z(a_in[2]) { }

    //! Constructor by passing an array of floats to initialize vector.
    rtsVector3d(const float* a_in) : x(a_in[0]), y(a_in[1]), z(a_in[2]) { }
    ...
    */
	//-----------------------------------------------------------------------
    inline void operator+= (const rtsVector3d& a_input)
    {
		x += a_input.x;
		y += a_input.y;
		z += a_input.z;
    ...
    */
    //-----------------------------------------------------------------------
    inline void copyto(rtsVector3d& a_destination) const
    {
		a_destination.x = x;
		a_destination.y = y;
		a_destination.z = z;
    ...
    */
    //-----------------------------------------------------------------------
    inline void copyfrom(const rtsVector3d &a_source)
    {
		x = a_source.x;
		y = a_source.y;
		z = a_source.z;
    ...
    */
    //-----------------------------------------------------------------------
    inline void add(const rtsVector3d& a_vector)
    {
		x = x + a_vector.x;
		y = y + a_vector.y;
		z = z + a_vector.z;
    ...
    */
    //-----------------------------------------------------------------------
    inline void addr(const rtsVector3d& a_vector, rtsVector3d& a_result) const
    {
    ...
    */
    //-----------------------------------------------------------------------
    inline void addr(const double& a_x, const double& a_y, const double& a_z, rtsVector3d& a_result) const
    {
		a_result.x = x + a_x;
		a_result.y = y + a_y;
		a_result.z = z + a_z;
    ...
    */
    //-----------------------------------------------------------------------
    inline void sub(const rtsVector3d& a_vector)
    {
		x = x - a_vector.x;
		y = y - a_vector.y;
		z = z - a_vector.z;
    ...
    */
    //-----------------------------------------------------------------------
    inline void subr(const rtsVector3d& a_vector, rtsVector3d& a_result) const
    {
		a_result.x = x - a_vector.x;
		a_result.y = y - a_vector.y;
		a_result.z = z - a_vector.z;
    ...
    */
    //-----------------------------------------------------------------------
    inline void mulr(const double& a_scalar, rtsVector3d& a_result) const
    {
    ...
    */
    //-----------------------------------------------------------------------
    inline void divr(const double& a_scalar, rtsVector3d& a_result) const
    {
    ...
    */
    //-----------------------------------------------------------------------
    inline void negater(rtsVector3d& a_result) const
    {
		a_result.x = -x;
		a_result.y = -y;
		a_result.z = -z;
    ...
    */
    //-----------------------------------------------------------------------
    inline void cross(const rtsVector3d& a_vector)
    {
    ...
    */
    //-----------------------------------------------------------------------
    inline rtsVector3d crossAndReturn(const rtsVector3d& a_vector) const
    {
		rtsVector3d r;
		crossr(a_vector,r);
		return (r);
    ...
    */
    //-----------------------------------------------------------------------
    inline void crossr(const rtsVector3d& a_vector, rtsVector3d& a_result) const
    {
    ...
    */
    //-----------------------------------------------------------------------
    inline double dot(const rtsVector3d& a_vector) const
    {
    ...
    */
    //-----------------------------------------------------------------------
    inline void elementMul(const rtsVector3d& a_vector)
    {
		x*=a_vector.x;
		y*=a_vector.y;
		z*=a_vector.z;
    ...
    */
    //-----------------------------------------------------------------------
    inline void elementMulr(const rtsVector3d& a_vector, rtsVector3d& a_result) const
    {
		a_result.x = x*a_vector.x;
		a_result.y = y*a_vector.y;
		a_result.z = z*a_vector.z;
    ...
    */
    //-----------------------------------------------------------------------
    inline void normalizer(rtsVector3d& a_result) const
    {
		// compute length of vector
		double length = sqrt((x * x) + (y * y) + (z * z));
    ...
    */
    //-----------------------------------------------------------------------
    inline double distance(const rtsVector3d& a_vector) const
    {
    ...
    */
    //-----------------------------------------------------------------------
    inline double distancesq(const rtsVector3d& a_vector) const
    {
		// compute distance between both points
		double dx = x - a_vector.x;
		double dy = y - a_vector.y;
    ...
    */
    //-----------------------------------------------------------------------
    inline bool equals(const rtsVector3d& a_vector, const double epsilon=0.0) const
    {
  ...
  //  }
    ...
    */
    //-----------------------------------------------------------------------
    inline void decompose(const rtsVector3d& a_input, rtsVector3d& a_parallel, rtsVector3d& a_perpendicular)
    {
    ...
    */
    //-----------------------------------------------------------------------
    inline void slerp(double a_level, rtsVector3d const& a_vector1, rtsVector3d a_vector2)
    {
...
*/
//---------------------------------------------------------------------------
inline rtsVector3d operator*(const rtsVector3d& v, const double a_input)
{
	return (rtsVector3d(v.x*a_input,v.y*a_input,v.z*a_input));
}
...
*/
//---------------------------------------------------------------------------
inline rtsVector3d operator*(const double a_input, const rtsVector3d& v)
{
    return rtsVector3d(v.x*a_input,v.y*a_input,v.z*a_input);
}
...
*/
//---------------------------------------------------------------------------
inline rtsVector3d operator+(const rtsVector3d& v1, const rtsVector3d& v2)
{
    return rtsVector3d(v1.x+v2.x,v1.y+v2.y,v1.z+v2.z);
}
...
*/
//---------------------------------------------------------------------------
inline double operator*(const rtsVector3d& v1, const rtsVector3d& v2)
{
...
//---------------------------------------------------------------------------
/*!
An overloaded < operator for sorting.
*/
//---------------------------------------------------------------------------
inline bool operator<(const rtsVector3d& v1, const rtsVector3d& v2)
{
...
*/
//---------------------------------------------------------------------------
static inline std::ostream &operator << (std::ostream &a_os, rtsVector3d const& a_vec)
{
