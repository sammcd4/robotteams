...
rtsHotspotGroup::rtsHotspotGroup(int a_id, bool a_showTargets)
{
	m_groupId = a_id;
	initTargetGroup();

	// choose to show hidden targets
	m_showTargets = a_showTargets;
}

rtsHotspotGroup::~rtsHotspotGroup()
{
	deallocate();
}

void rtsHotspotGroup::addTarget(rtsHotspot* a_target)
{
...
void rtsHotspotGroup::initTargetGroup()
{
...
void rtsHotspotGroup::setFoundState(bool a_foundState)
{ 
...
void rtsHotspotGroup::setTargetFoundStates(bool a_foundState)
{
	int numTargets = m_targets.size();
	for (int i = 0; i < numTargets; i++)
	{
...
void rtsHotspotGroup::setColor(cColorf a_color)
{
	int numTargets = m_targets.size();
	for (int i = 0; i < numTargets; i++)
	{
...
void rtsHotspotGroup::deallocate()
{
	// delete all children
...
void rtsHotspotGroup::setActiveState(bool a_active)
{
	m_active = a_active;
}

void rtsHotspotGroup::setStartTime(double a_startTime)
{
	m_startTime = a_startTime;
}

void rtsHotspotGroup::setEndTime(double a_endTime)
{
	m_endTime = a_endTime;
}

void rtsHotspotGroup::setStartAndEndTimes(double a_startTime, double a_endTime)
{
	m_startTime = a_startTime;
	m_endTime = a_endTime;
}

void rtsHotspotGroup::updateActiveState(double a_simTime, int a_currentBldgId)
{
	if (m_faded)
	{
		// do nothing
...
void rtsHotspotGroup::checkFoundStates(double a_time)
{
...
void rtsHotspotGroup::beginFadeOut()
{
